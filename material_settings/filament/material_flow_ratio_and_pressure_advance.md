...
[CLI Example](cli_mode#setting-overrides): `--filament-flow-ratio=1`.  
...
[Type](option_type): `enable_pressure_advance` (Boolean list), `pressure_advance` (Float list).  
[CLI Example](cli_mode#setting-overrides): `--enable-pressure-advance=1` (`enable_pressure_advance` shown; other variables above follow their own type).  
...
[CLI Example](cli_mode#setting-overrides): `--adaptive-pressure-advance=1`.  
...
[Type](option_type#list-types): `Boolean list`.  
[CLI Example](cli_mode#setting-overrides): `--adaptive-pressure-advance-overhangs=1`.  
...
[Type](option_type#list-types): `Float list`.  
[CLI Example](cli_mode#setting-overrides): `--adaptive-pressure-advance-bridges=1`.  
